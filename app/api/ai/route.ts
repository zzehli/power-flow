...
Use $...$ to render math as inline, and $$...$$ to render as block. Don't use numbered list. Don't include citations when you generate. Don't end the last page with ---. Don't wrap the whole output around ```"
